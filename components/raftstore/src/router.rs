    ...
    EK: KvEngine,
{
    ...
    fn send_command_with_deadline(
        ...
        send_command_impl::<EK, _>(self, req, cb, Some(deadline), allowed_on_full)
    }
    ...
    fn send_command_without_deadline(
        ...
        send_command_impl::<EK, _>(self, req, cb, None, allowed_on_full)
    }
    ...
    PR: ProposalRouter<EK::Snapshot>,
{
    ...
    cmd.allowed_on_full = allowed_on_full;
    router
        .send(cmd)
